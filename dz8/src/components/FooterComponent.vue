    ...
    <footer class="footer center">
        <div class="footer__left">
            <div class="footer__left_logo">
                <router-link class="footer__left_logo-a" to="./"><img src="@/assets/img/Logo.svg" alt="logotip">
                ...
                <div class="footer__left__icons">
                    <a href="#"><svg width="19" height="16" viewBox="0 0 19 16" fill="none"
        ...
        <div class="footer__center">
            ...
            <div class="footer__center__link-wrap">
                <router-link class="footer__center__link" :to="link.url" v-for="link in pageLinks" :key="link.id">{{ link.title }}</router-link>
            </div>
        </div>
